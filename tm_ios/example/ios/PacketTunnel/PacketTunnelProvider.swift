...
class PacketTunnelProvider: NEPacketTunnelProvider {
    ...
    private static let defaultSharedDirectory: URL! = FileManager.default
        .containerURL(
            forSecurityApplicationGroupIdentifier: "group.com.example.tmIosExample"
        )
    ...
    override func startTunnel(
        ...
        ///Users/v/Library/Group Containers/K4FDLB3LLD.com.5vnetwork.x/Library/Caches/stderr.log
        ///
        ...
        let settings = try getNetworkSetting(map: map)
        ...
        X_darwinRedirectStderr(
            PacketTunnelProvider.defaultSharedDirectory.appendingPathComponent(
                ...
                .appendingPathComponent("packetTunnel.log").relativePath, &error
        )
        if let error {
    ...
    private func getNetworkSetting(map: [String: NSObject]) throws
