...
class ShadowsocksAccount extends $pb.GeneratedMessage {
  factory ShadowsocksAccount({
  ...
  ShadowsocksAccount._();

  factory ShadowsocksAccount.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ShadowsocksAccount.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ShadowsocksAccount',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'vx.proxy.shadowsocks'),
      createEmptyInstance: create)
    ..aE<ShadowsocksCipherType>(2, _omitFieldNames ? '' : 'cipherType',
        enumValues: ShadowsocksCipherType.values)
    ..aOB(3, _omitFieldNames ? '' : 'ivCheck')
    ..aOM<$0.UserConfig>(4, _omitFieldNames ? '' : 'user',
        subBuilder: $0.UserConfig.create)
    ..aOB(90001, _omitFieldNames ? '' : 'experimentReducedIvHeadEntropy')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ShadowsocksAccount clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ShadowsocksAccount copyWith(void Function(ShadowsocksAccount) updates) =>
      super.copyWith((message) => updates(message as ShadowsocksAccount))
          as ShadowsocksAccount;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ShadowsocksAccount create() => ShadowsocksAccount._();
  @$core.override
  ShadowsocksAccount createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static ShadowsocksAccount getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ShadowsocksAccount>(create);
  static ShadowsocksAccount? _defaultInstance;

  @$pb.TagNumber(2)
  ShadowsocksCipherType get cipherType => $_getN(0);
  @$pb.TagNumber(2)
  set cipherType(ShadowsocksCipherType value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasCipherType() => $_has(0);
  @$pb.TagNumber(2)
  void clearCipherType() => $_clearField(2);
  ...
  @$pb.TagNumber(3)
  void clearIvCheck() => $_clearField(3);

  @$pb.TagNumber(4)
  $0.UserConfig get user => $_getN(2);
  @$pb.TagNumber(4)
  set user($0.UserConfig value) => $_setField(4, value);
  @$pb.TagNumber(4)
